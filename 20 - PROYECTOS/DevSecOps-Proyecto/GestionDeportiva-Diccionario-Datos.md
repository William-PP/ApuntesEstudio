...
> Documentación en tablas del modelo relacional (SQL Server, v4). Complementa el diagrama de clases ([[20 - PROYECTOS/DevSecOps-Proyecto/GestionDeportiva-Diagrama-Clases]]).
...
> Cuando diseñes la API sobre este esquema, [[40 - RECURSOS/Conceptos/Best-Practices]] y [[40 - RECURSOS/Conceptos/Anti-Patrones-Seguridad]] son la checklist a aplicar directamente sobre estos endpoints. El detalle de mitigación por endpoint (autorización, rate limiting, manejo de errores) está desarrollado ahí, no repetido acá.
...
- [[20 - PROYECTOS/DevSecOps-Proyecto/GestionDeportiva-Diagrama-Clases]] — diagrama UML equivalente, con las notas de diseño completas de los dos gaps señalados en §4 y §10
