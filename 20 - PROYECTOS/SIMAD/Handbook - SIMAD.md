...
updated: 2026-09-05
related: [SIMAD]
tags: [simad, handbook, proyecto, documentacion, ciclo-de-vida, planificacion, despliegue, monitoreo]
aliases: [Handbook SIMAD, Manual del Proyecto SIMAD]
---

# Handbook — SIMAD

> [!info] Handbook del proyecto
> Réplica de la [[Guía - Documentación de Proyectos de Software]] del vault, adaptada como plantilla de trabajo del proyecto **SIMAD**. Contenido pendiente de personalizar por el equipo.
...
- [x] Acta de constitucion del Proyecto: Informacion basica del proyecto, justificacion y problema, objetivos del proyecto, usuarios finales y grupos de interes, alcance del proyecto, restricciones y proyectos, matriz de interesados, exito del proyecto, riesgos identificados
- [x] Narrativa verbal: Descripción del Problema Actual, Causas Identificadas, Impacto en el Negocio y los Usuarios, Flujo Actual de Procesos, Propuesta de Solución, Beneficios Operacionales,
- [x] Stack Tecnologico: Lenguaje, frameworks, base de datos, etc.
- [x] Seguridad inicial: Clasificacion de datos, regulaciones, threat landscapes y politicas de secretos.
...
- [[20 - PROYECTOS/SIMAD/Etapa 1/Acta de Constitución - SIMAD]] — charter (Etapa 1)
- [[20 - PROYECTOS/SIMAD/Etapa 1/Stack Tecnológico - SIMAD]] — decisiones técnicas (Etapa 1)
- [[20 - PROYECTOS/SIMAD/Etapa 1/Seguridad Inicial - SIMAD]] — postura de seguridad (Etapa 1)
- [[20 - PROYECTOS/SIMAD/Etapa 1/Narrativa - SIMAD]] — requisitos del sistema (Etapa 1)
- [[20 - PROYECTOS/SIMAD/Diccionario de Entidades - SIMAD]] — modelo de datos
- [[Guía - Documentación de Proyectos de Software]] — guía genérica del vault

**Versión:** 1.0 · **Uso interno:** handbook de trabajo del proyecto SIMAD

#simad #handbook #proyecto #documentacion #ciclo-de-vida #planificacion #despliegue #monitoreo